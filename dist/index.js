...
define("@scom/scom-gem-token/config/index.css.ts", ["require", "exports", "@ijstech/components"], function (require, exports, components_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.tableStyle = exports.customStyle = void 0;
    const Theme = components_3.Styles.Theme.ThemeVars;
    exports.customStyle = components_3.Styles.style({
        $nest: {
            'input': {
                paddingLeft: '10px'
            },
    ...
    exports.tableStyle = components_3.Styles.style({
        $nest: {
...
define("@scom/scom-gem-token/config/index.tsx", ["require", "exports", "@ijstech/components", "@ijstech/eth-wallet", "@scom/scom-gem-token/utils/index.ts", "@scom/scom-gem-token/store/index.ts", "@scom/scom-gem-token/assets.ts", "@scom/scom-gem-token/config/index.css.ts"], function (require, exports, components_4, eth_wallet_6, index_6, index_7, assets_1, index_css_1) {
    ...
    let Config = class Config extends components_4.Module {
            ...
            this.commissionsTableColumns = [
                {
                    ...
                    onRenderCell: function (source, columnData, rowData) {
                        const network = index_7.SupportedNetworks.find(net => net.chainId === columnData);
                        if (!network)
                            return this.$render("i-panel", null);
                        const imgUrl = assets_1.default.img.network[network.img] || '';
                        const hstack = new components_4.HStack(undefined, {
                            verticalAlignment: 'center',
                            gap: 5
                        });
                        const imgEl = new components_4.Icon(hstack, {
                            image: { url: imgUrl, width: 16, height: 16 }
                        });
                        const lbName = new components_4.Label(hstack, {
                ...
                },
                {
                    ...
                    onRenderCell: function (source, columnData, rowData) {
                        ...
                        return new components_4.Label(undefined, {
                            caption: caption || '',
                            font: { size: '0.875rem' },
                            tooltip: {
                                content: columnData
                ...
                },
                {
                    ...
                    onRenderCell: async (source, data, rowData) => {
                        const icon = new components_4.Icon(undefined, {
                            name: "edit",
        ...
        async init() {
            ...
            const embedderFee = index_7.getEmbedderCommissionFee();
            this.lbCommissionShare.caption = `${index_6.formatNumber(new eth_wallet_6.BigNumber(embedderFee).times(100).toFixed(), 4)} %`;
        }
        get data() {
            const config = {};
            ...
            return (this.$render("i-vstack", { gap: '0.5rem', padding: { top: '1rem', bottom: '1rem' }, class: index_css_1.customStyle },
                ...
                this.$render("i-modal", { id: 'modalAddCommission', maxWidth: '600px', closeIcon: { name: 'times-circle' }, onClose: this.onModalAddCommissionClosed },
                    this.$render("i-grid-layout", { width: '100%', verticalAlignment: 'center', gap: { row: '1rem' }, padding: { top: '1rem', bottom: '1rem', left: '2rem', right: '2rem' }, templateColumns: ['1fr', '3fr'], templateRows: ['auto', 'auto', 'auto', 'auto'], templateAreas: [
                        ...
                        this.$render("i-scom-network-picker", { id: 'networkPicker', grid: { area: 'network' }, display: "block", type: 'combobox', networks: index_7.SupportedNetworks, background: { color: Theme.combobox.background }, border: { radius: 8, width: '1px', style: 'solid', color: Theme.input.background }, onCustomNetworkSelected: this.onNetworkSelected, class: "nft-network-select" }),
    ...
    Config = __decorate([
        ...
        components_4.customElements("i-scom-gem-token-config")
    ], Config);
    exports.default = Config;
});
define("@scom/scom-gem-token/token-selection/index.css.ts", ["require", "exports", "@ijstech/components"], function (require, exports, components_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.modalStyle = exports.tokenStyle = exports.buttonStyle = exports.scrollbarStyle = void 0;
    const Theme = components_5.Styles.Theme.ThemeVars;
    exports.scrollbarStyle = components_5.Styles.style({
        $nest: {
    ...
    exports.buttonStyle = components_5.Styles.style({
        boxShadow: 'none'
    });
    exports.tokenStyle = components_5.Styles.style({
        $nest: {
            '&:hover': {
...
define("@scom/scom-gem-token/token-selection/index.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-gem-token/store/index.ts", "@scom/scom-gem-token/assets.ts", "@scom/scom-gem-token/wallet/index.ts", "@scom/scom-gem-token/token-selection/index.css.ts"], function (require, exports, components_6, index_8, assets_2, index_9, index_css_2) {
    ...
    let TokenSelection = class TokenSelection extends components_6.Module {
        ...
        onSetup(init) {
            ...
            if (init && this.token && !this.readonly) {
                const chainId = index_9.getChainId();
                const _tokenList = index_8.getTokenList(chainId);
        ...
        get tokenList() {
            ...
            return _tokenList.map((token) => {
                ...
                const nativeToken = index_8.ChainNativeTokenByChainId[chainId];
                if (token.symbol === nativeToken.symbol) {
                    Object.assign(tokenObject, { isNative: true });
                }
                if (!index_9.isWalletConnected()) {
        ...
        updateTokenButton(token) {
            const chainId = this.chainId || index_9.getChainId();
            if (token) {
                const tokenIconPath = assets_2.default.tokenPath(token, chainId);
    ...
    TokenSelection = __decorate([
        components_6.customElements('i-scom-gem-token-selection')
    ], TokenSelection);
...
define("@scom/scom-gem-token/alert/index.tsx", ["require", "exports", "@ijstech/components"], function (require, exports, components_8) {
    ...
    Alert = __decorate([
        components_8.customElements('i-scom-gem-token-alert')
    ], Alert);
    exports.Alert = Alert;
    ;
});
...
define("@scom/scom-gem-token/API.ts", ["require", "exports", "@ijstech/eth-wallet", "@scom/scom-gem-token/contracts/scom-gem-token-contract/index.ts", "@scom/scom-gem-token/contracts/scom-commission-proxy-contract/index.ts", "@scom/scom-gem-token/utils/index.ts", "@scom/scom-gem-token/store/index.ts", "@scom/scom-gem-token/wallet/index.ts"], function (require, exports, eth_wallet_8, index_10, index_11, index_12, index_13, index_14) {
    ...
    async function getFee(contractAddress, type) {
        ...
        const contract = new index_10.Contracts.GEM(wallet, contractAddress);
    ...
    async function deployContract(options, token, callback, confirmationCallback) {
        const wallet = eth_wallet_8.Wallet.getInstance();
        index_12.registerSendTxEvents({
            transactionHash: callback,
            confirmation: confirmationCallback
        });
        const gem = new index_10.Contracts.GEM(wallet);
    ...
    async function getGemInfo(contractAddress) {
        var _a;
        const wallet = eth_wallet_8.Wallet.getInstance();
        const gem = new index_10.Contracts.GEM(wallet, contractAddress);
        try {
            ...
            const baseToken = (_a = index_13.DefaultTokens[chainId]) === null || _a === void 0 ? void 0 : _a.find(t => { var _a; return ((_a = t.address) === null || _a === void 0 ? void 0 : _a.toLowerCase()) == baseTokenValue.toLowerCase(); });
            return {
                price: priceValue,
    ...
    async function buyToken(contractAddress, backerCoinAmount, token, commissions, callback, confirmationCallback) {
        try {
            ...
            if (commissionsAmount.isZero()) {
                ...
                let proxyAddress = index_13.getContractAddress('Proxy');
    ...
    async function redeemToken(address, gemAmount, callback, confirmationCallback) {
        try {
            ...
            const wallet = eth_wallet_8.Wallet.getInstance();
            const contract = new index_10.Contracts.GEM(wallet, address);
    ...
    let ScomGemToken = class ScomGemToken extends components_9.Module {
                ...
                const callback = (error, receipt) => {
                    if (error) {
                        this.mdAlert.message = {
                            status: 'error',
                            content: index_15.parseContractError(error)
                        };
        ...
        async onSetupPage(isWalletConnected) {
            if (isWalletConnected)
                this.networkPicker.setNetworkByChainId(index_17.getChainId());
        ...
        async refreshDApp() {
            ...
            if (this.gemInfo) {
                ...
                if (!this.isBuy) {
                    ...
                    this.backerTokenImg.url = assets_3.default.tokenPath(this.gemInfo.baseToken, index_17.getChainId());
                    this.backerTokenBalanceLb.caption = '0.00';
                }
        ...
        get contract() {
            var _a, _b, _c;
            return (_c = (_b = (_a = this._data.chainSpecificProperties) === null || _a === void 0 ? void 0 : _a[index_17.getChainId()]) === null || _b === void 0 ? void 0 : _b.contract) !== null && _c !== void 0 ? _c : '';
        }
        get dappType() {
            var _a;
        ...
        async initApprovalAction() {
            if (!this.approvalModelAction) {
                this._entryContract = index_16.getContractAddress('Proxy');
                this.approvalModelAction = index_15.getERC20ApprovalModelAction(this._entryContract, {
                    sender: this,
                    payAction: async () => {
        ...
        async getBalance(token) {
            ...
            if (this.isBuy && tokenData) {
                balance = await index_15.getTokenBalance(tokenData);
            }
                    ...
                    this.$render("i-grid-layout", { id: 'gridDApp', width: '100%', height: '100%', templateColumns: ['repeat(2, 1fr)'], padding: { bottom: '1.563rem' } },
                        ...
                        this.$render("i-vstack", { gap: "0.5rem", padding: { top: '1rem', bottom: '0.5rem', left: '0.5rem', right: '0.5rem' }, verticalAlignment: 'space-between' },
                            ...
                            this.$render("i-grid-layout", { width: '100%', verticalAlignment: 'center', padding: { top: '1rem', bottom: '1rem', left: '1rem', right: '1rem' }, templateColumns: ['1fr', '2fr'], templateRows: ['auto'], templateAreas: [
                                ...
                                this.$render("i-scom-network-picker", { id: 'networkPicker', type: "combobox", grid: { area: 'network' }, networks: index_16.SupportedNetworks, switchNetworkOnSelect: true, selectedChainId: index_17.getChainId(), onCustomNetworkSelected: this.onNetworkSelected })),
